...
public class MainMenu {
    ...
    private static final HotelResource hotelResource = HotelResource.getSingleton(); // instantiate the object of HotelResource class
        ...
        try {
            do {
                ...
                if (line.length() == 1) {
                    ...
                    System.out.println("Error: Invalid action\n"); // insert more than one char, go to error
                }
